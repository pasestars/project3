...
//Update one
router.patch('/useremail/:email', getUserByEmail, async (req, res) => {
    if (req.body.name != null) {
        req.user.name = req.body.name;
    }
    if (req.body.email != null) {
...
//Getting one
router.get('/useremail/:email', getUserByEmail, async (req, res) => {
    res.send(req.user);
});

//Deleting one
router.delete('/useremail/:email', getUserByEmail, async (req, res) => {
    try {
