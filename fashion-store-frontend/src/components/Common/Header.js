...
import logoFull from './../../assets/images/logoFullStore.png';
...
class Header extends Component {
    ...
    render() {
        const { visible, openProfileModal, openAuthModal } = this.state;
        const { match, dataUser } = this.props;
            ...
            <div className='container-fluid'>
                <div className='header'>
                    <div className='logo'>
                        ...
                        <NavLink to={links.TRANG_CHU} title='Menu'>
                            <img src={logoFull} height={'60px'} />
                        </NavLink>
                    </div>
                    <div className='mobileHidden'>
                        <Anchor targetOffset='65'>
                            <Link
                                href={links.TRANG_CHU + '#trang-chu'}
                                title='Trang chủ'
                            />
                            <div className='ant-anchor-link'>
                                <NavLink to={links.DANH_MUC_LOAI}>
                                    Danh mục
                                </NavLink>
                            </div>
                            <div className='ant-anchor-link'>
                                <NavLink to={links.GIO_HANG}>Giỏ hàng</NavLink>
                            </div>
                            <Link
                                href={links.TRANG_CHU + '#ve-chung-toi'}
                                title='Về chúng tôi'
                            />
                            <Link
                                href={links.TRANG_CHU + '#dac-trung'}
                                title='Đặc trưng'
                            />
                            <Link
                                href={links.TRANG_CHU + '#lien-he'}
                                title='Liên hệ'
                            />
                        </Anchor>
                        {checkToken ? (
