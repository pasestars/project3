...
class Menu extends Component {
    ...
    render() {
        ...
        const { isLoading, menuTypeList } = this.state;
                                ...
                                >
                                    ...
                                    <NavLink
                                        to={links.DANH_MUC_DANH_SACH.replace(
                                            ':idType',
                                            menuTypeItem.id
                                        ).replace(':name', menuTypeItem.name)}
                                    >
                                        <div
                                            className={'clickShowMenu'}
                                            style={{
                                                color: menuTypeItem.clickColor,
                                                borderColor:
                                                    menuTypeItem.clickColor,
                                            }}
                                        >
                                            Xem chi tiết
                                        </div>
