...
import san_pham_chat_luong from '../../assets/images/san_pham_chat_luong.jpg';
            ...
            <div id='dac-trung' className='block featureBlock bgGray'>
                <div className='container-fluid'>
                    <div className='titleHolder'>
                        <h2>Fashion Store - Tận hưởng cuộc sống</h2>
                        ...
                        >
                            <Card
                                ...
                                cover={
                                    <img
                                        style={{ height: 240 }}
                                        alt='Nhân viên thân thiện'
                                        src={nhan_vien_than_thien}
                                    />
                                }
                            >
                        ...
                        >
                            <Card
                                ...
                                cover={
                                    <img
                                        style={{ height: 240 }}
                                        alt='Sáng tạo không ngừng'
                                        src={sang_tao_khong_ngung}
                                    />
                                }
                            >
