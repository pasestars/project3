...
class MenuList extends Component {
    ...
    getProduct(idType) {
        axios
            .get(BASE_API + '/api/product?typeId=' + idType)
            .then((res) => {
                console.log(res);
                if (res.status === 200) {
    ...
    render() {
        ...
        const { isLoading, menuTypeList, idType, menuList } = this.state;
        const settings = {
            dots: true,
            infinite: true,
            speed: 500,
            ...
            <div className='menuListWrapper'>
                <Row>
                    ...
                    <Col
                        ...
                        className='menuList'
                    >
                        {this.getMenuTypeById(idType).length && (
                            <div
                                className='infoMenuType'
                                style={{
                                    backgroundImage: `url(${
                                        this.getMenuTypeById(idType)[0].bg
                                    })`,
                                }}
                            >
                                <Row>
                                    ...
                                    <Col
                                        ...
                                        lg={16}
                                        xl={16}
                                        className='describeMenu'
                                    >
                                        <h2
                                            style={{
                                                color: this.getMenuTypeById(
                                                    idType
                                                )[0].nameColor,
                                            }}
                                            className='name'
