...
class Cart extends Component {
    constructor(props) {
        ...
        this.openNotificationWithIcon = this.openNotificationWithIcon.bind(
            this
        );
    ...
    Cart() {
        ...
        if (this.state.timeOrder) {
            ...
            axiosClient
                .patch('api/table/book/' + this.state.idTableCurrent, {
                ...
                .then((res) => {
                    ...
                    if (res.status === 200) {
                        if (res.data._id) {
                            ...
                            this.openNotificationWithIcon(
                                'warning',
                                'Có một số người đã đặt bàn này'
                            );
                        }
                    } else {
        ...
        return (
            <div className='cartWrapper'>
                ...
                {!checkToken && (
                    <div className='auth'>
                        <div className='text'>
                            Để mua hàng bạn hay đăng nhập hoặc đăng ký tài khoản
                            khách hàng tại đây
                        </div>
                        <Button
                            className='btnAuth'
                ...
                >
                    <div className='orderModalWrapper'>
                        ...
                        <Button className='btnBook' onClick={() => this.Cart()}>
                            Đặt bàn
                        </Button>
                    </div>
                </Modal>
